...
**Поддерживаемые платформы:** Windows, MATLAB R2021b+ (желательно).
...
2. **Запусти MATLAB и добавь корневую папку проекта в path.**
...
3. **Запусти эксперимент:**
   ...
   Следуй подсказкам в консоли — укажи параметры, диапазон температур, путь сохранения данных.
...
| TBOX       | 10      | Установка температуры термобокса| ComGet        |
