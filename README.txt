...
- r20   — реальная температуры лазера (попугаи). Читать:  ComGet(tbox, 20).
- r30   — реальная температура установки (попугаи). Читать:  ComGet(tbox, 20).
...
- при r80 = 3: ?? за 1 попугай ? 0.09 * 0.0004 = 0.000036 нм = 0.036 пм
- при r80 = 4: ?? за 1 попугай ? 0.09 * 0.00004 = 0.0000036 нм = 0.0036 пм
...
- Если изменили r80, помните: «цена деления» в попугаях меняется в 2 раз.
